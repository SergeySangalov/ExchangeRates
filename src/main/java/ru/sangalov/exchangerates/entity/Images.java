...
public class Images {
    ...
    private ru.sangalov.exchangerates.entity._480wStill _480wStill;
    @JsonIgnore
    ...
    @JsonProperty("480w_still")
    public ru.sangalov.exchangerates.entity._480wStill get480wStill() {
        return _480wStill;
    }

    @JsonProperty("480w_still")
    public void set480wStill(ru.sangalov.exchangerates.entity._480wStill _480wStill) {
